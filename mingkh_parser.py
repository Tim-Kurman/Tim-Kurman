...
proxy = 'http://o3ry9obf:bgnwhu5g@kate.onlinesim.ru:14959'
...
# У МИНЖКХ не оказалось удобного API со всей инфой, так что BS мне в помощь
r = requests.get(base_url)
gen_soup = BeautifulSoup(r.text, 'html.parser')

# ищу все регионы и собираю их в одном листе, чтоб создать лист с URL
...
if __name__ == '__main__':
    for reg in region_urls[42:]:
        ...
        print(f'does data length match original number of {name} urls?: ' + str(len(df) == len(houses_df)))
